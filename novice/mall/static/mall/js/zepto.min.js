...
var utils = {
    ...
    payDeal: function (a, b) {
        ...
        var c, d = a.data;
        //   alert("下单成功后，跳转到结果页面d.payType:" + a.payType);
        var returnpage = window.basePath + "/shop/userinfo.aspx?wid=" + +$("#hidwid").val() + "&openid=" + $("#openid").val();
        if (a.payType == "1") {//货到付款
            location.href = window.basePath + "/shop/order_success.aspx?wid=" + $("#hidwid").val() + "&openid=" + $("#openid").val() + "&orderid=" + a.orderid + "&rpage=" + escape(returnpage);
        }
        else {
            //微支付
            // alert("微支付111");
            location.href = window.basePath + "/api/payment/paypage.aspx?showwxpaytitle=1&paytype=shop&wid=" + $("#hidwid").val() + "&openid=" + $("#openid").val() + "&orderid=" + a.orderid + "&rpage=" + escape(returnpage);
        }
...
utils.namespace("mobile.o2ocn.addrList"), utils.namespace("mobile.o2ocn.addrchoose"), function () {
    ...
    address.init = function () {
        ...
        $("#province").on("change", function () {
            ...
            utils.ajaxReq(e, function (f) {
                f.errCode || (a.setSelArea(a.cityNode, "选择市", f.data), a.regionNode.parent().addClass("qb_none"),
                ("35" == b) && (c = $("#scity").attr("data-url"), d.ctid = f.data[0].id, a.cityNode.val(d.ctid), e.url = c, e.data = d, utils.ajaxReq(e, function (b) {
    ...
    g.init = function () {
        ...
        }, a.priceNode = $("#total-price"),
        a.pkgShipFeeNode = $("#select_shipFee"),
        a.pkgLen = parseInt(b.pkgLen, 10), a.curMtype = "",
        a.curShipFee = "", a.isFreeFee = !1,
        a.reduce = 0, a.couponReduce = 0,
        a.promoteId = 0, a.couponId = null,
        a.useCoupon = !0, a.payPrice = 0,
        a.pc = "true" === b.minipay ? -1 : 0, a.promoteIndex = {
            0: {
                op: "-",
                num: b.totalPrice
            },
        ...
        if (!a.hasClass("btn_disabled")) {
            ...
            if ("0" === d && b.pc < 0) return utils.showBubble("请选择支付方式11"), void 0;
    ...
    a.initCmdyList = function () {
        var a = this;
        a.itemList = $("#item-sec .item"), 0 != a.itemLen && (a.selectAll = $("#choose-all"),
        a.itemList.each(function () {
            var b = $(this),
				c = b.find(".cmdy-data"),
				d = c.attr("supportCod"),
				e = b.find("i").eq(0);
            a.selectItems.number++, a.selectItems.items[e.attr("index")] = e, a.choseNode.push(e), "false" == d && (a.unSupCodList[e.attr("index")] = e, a.unSupCodLen++, a.chosedUnCodLen++),
            e.on("click", function () {
                var b, c = $(this),
					d = c.attr("index");
                return c.hasClass("icon_checkbox_disabled") ? (utils.showBubble("您选择的商品不支持货到付款，建议您选择在线支付"), void 0) : (b = c.hasClass("icon_checkbox_checked"), b ? (c.removeClass("icon_checkbox_checked").html(""), c.removeClass("icon_checkbox_checked"), delete a.selectItems.items[d], a.selectItems.number--) : (c.addClass("icon_checkbox_checked"), a.selectItems.items[d] = c, a.selectItems.number++), a.selectItems.number < a.itemLen ? a.selectAll.removeClass("icon_checkbox_checked") && a.selectAll.removeClass("icon_checkbox_checked").html("") : a.selectAll.addClass("icon_checkbox_checked") && a.selectAll.addClass("icon_checkbox_checked").html("&#xe610;"), a.callUnCod(b, d), a.changeSel(), void 0)
            })
        }),
    ...
    a.callUnCod = function (a, b) {
        ...
        utils.ajaxReq({
            type: "POST",
            url: window.basePath + "/shop/shopmgr.ashx?myact=modifyNum",
            data: {
                ic: d.attr("ic"),
                attr: d.attr("sa"),
                mid: d.attr("mid"),
        ...
        utils.ajaxReq({
            type: "POST",
            url: window.basePath + "/shop/shopmgr.ashx?myact=remove",
            data: i,
            dataType: "json"
        }, function (d) {
            if (d.errCode) utils.showAjaxErr(d, "操作失败,请稍候再试");
                ...
                b && a.find("i[name=cart_checkbox]").hasClass("icon_checkbox_checked") && a.find("i[name=cart_checkbox]").hasClass("icon_checkbox_checked").html("&#xe610;") && (delete c.selectItems.items[a.attr("id")], c.selectItems.number--), b && ("false" == h && c.unSupCodLen--, c.unSupCodLen == c.itemLen && c.selectDivNode.html("<p>付款方式：在线支付</p>"), setTimeout(function () {
                    c.changeSel()
        ...
        if (window.wxInfo && "true" != window.wxInfo.isFocus) return business.focus("购买商品，需要关注该商户，是否立即关注?",
            $.proxy(a.confirmOrder, this)), void 0;
        for (var e in b.selectItems.items) c.push(b.itemCache[e].mid);
        $("#payType").val(b.payType), $("#trandom").val((new Date).getTime() / 1e3),
        $("#itemList").val(c.join("~")),
    ...
    g.init = function () {
        ...
        if (!c.hasClass("btn_disabled")) {
            ...
            if (b.pc < 0 && 1 != b.curPtype) return utils.showBubble("请选择支付方式22"), !1;
            d.mt = b.curMtype,
            d.pt = b.curPtype,
            d.adid = e.adid,
            d.promId = b.promoteId ? b.promoteId : 0,
            d.pc = b.pc,
            d.comeFrom = e.comeFrom,
            d.t = +new Date,
            d.couponId = b.couponId ? b.couponId : 0,
            utils.showBubble("正在提交订单数据..."), c.addClass("btn_disabled"), utils.ajaxReq({
    ...
    a.init = function () {
        ...
        if (this.buyNode.hasClass("btn_strong")) {
            ...
            $("#attr").val(encodeURIComponent(this.buyProperty)),
            $("#mid").val(window.availSku[this.buyProperty].pid),
            $("#bc").val(this.buyNum),
           a.addCart(),
        ...
        utils.ajaxReq({
            url: window.basePath + "/shop/shopmgr.ashx" + window.baseParam,
            dataType: "json",
            type: "POST",
            data: b
        }, function (b) {
            b.errCode ? utils.showConfirm({
                ...
                cancelText: "再逛逛",
                sureFn: function () {
                    location.href = window.basePath + "/shop/cart.aspx?" + $("#wid").val() + "&openid=" + $("#openid").val()
                }
            })
        })
    ...
    a.init = function () {
        ...
        b = b ? b : 0;
        var order_id = a.getAttribute("dc");
        //   alert("下单成功后，跳转到结果页面d.payType:" + a.payType);
        var returnpage = window.basePath + "/shop/userinfo.aspx?wid=" + +$("#hidwid").val() + "&openid=" + $("#openid").val();
        //微支付
        location.href = window.basePath + "/api/payment/paypage.aspx?showwxpaytitle=1&paytype=shop&wid=" + $("#hidwid").val() + "&openid=" + $("#openid").val() + "&orderid=" + order_id + "&rpage=" + escape(returnpage);
...
function getCmdyCount() {
    //alert("统计购物车数量1" + window.basePath + "/shop/shopmgr.ashx?myact=pcount" + "&wid=" + $("#wid").val() + "&openid=" + $("#openid").val());
    var a = $(".icon_number_bubble");
    0 != a.length && utils.ajaxReq({
        url: window.basePath + "/shop/shopmgr.ashx?myact=pcount" + "&wid=" + $("#wid").val() + "&openid=" + $("#openid").val(),
        dataType: "json",
...
utils.namespace("mobile.o2ocn.address"), function () {
    ...
    address.initParam = function () {
        ...
        this.isUpdate = parseInt($("#isUpdate").val(), 10),
        this.provId = parseInt($("#provId").val(), 9),
        this.oprTip = parseInt($("#oprTip").val(), 10),
        this.provinceNode = $("#province"),
        this.cityNode = $("#city"),
        this.regionNode = $("#regionId"),
        ...
        $.each(a.allProvince, function (b, c) {
            ...
            if (c.provinceId == a.provId) {
                a.provinceNode.append("<option value='" + c.provinceId + "' selected='selected'>" + c.pname + "</option>")
            } else {
                a.provinceNode.append("<option value='" + c.provinceId + "'>" + c.pname + "</option>")
            }
        }),
        ...
        $("#province").on("change", function () {
            ...
            //  alert("省份改变2=" + a.cityNode);
            utils.ajaxReq(e, function (f) {

                f.errCode || (
                a.setSelArea(a.cityNode, "选择市", f.data),
                a.regionNode.parent().addClass("qb_none"),
                ("36" == b || "35" == b) && (c = $("#scity").attr("data-url"),
                d.ctid = f.data[0].id,
                a.cityNode.val(d.ctid),
                e.url = c,
                e.data = d,
                utils.ajaxReq(e, function (b) {
    ...
    address.setSelArea = function (a, b, c) {
        return a.empty(),
            a.append("<option value='-1'>" + b + "</option> "),
            c.length <= 0 ? (a.parent().addClass("qb_none"), void 0) : ($.each(c, function (b, c) {
                a.append("<option value='" + c.id + "'>" + c.name + "</option>")
            }),
            a.parent().removeClass("qb_none"), void 0)
    },
    ...
    g.init = function () {
        ...
        }, a.priceNode = $("#total-price"), a.pkgShipFeeNode = $("#select_shipFee"),
        a.pkgLen = parseInt(b.pkgLen, 10), a.curMtype = "", a.curShipFee = "", a.isFreeFee = !1, a.reduce = 0, a.couponReduce = 0, a.promoteId = 0, a.couponId = null, a.useCoupon = !0, a.payPrice = 0, a.pc = "true" === b.minipay ? -1 : 0, a.promoteIndex = {
            0: {
                op: "-",
                num: b.totalPrice
            },
        ...
        var b = this,
			a = a || b.pkgShipFeeNode[0],
			c = a.options[a.selectedIndex];
        b.curMtype = c.getAttribute("mtype"),
        b.curShipFee = parseInt(c.value, 10),
        a && b.countPrice()
    }, g.scanCoupon = function () {
        var a, b, c = window.pageParam,
			d = this,
        ...
        var a, b = this,
			c = window.pageParam,
			d = c.totalPrice + b.couponReduce;
        if (1 > d && (d = 1), d += b.reduce, 1 > d && (d = 1),
            a = d + (b.isFreeFee ? 0 : b.curShipFee),
            "1" === c.payType && 500 > a && utils.showBubble("您购买的商品应付总价低于5元，无法使用货到付款功能，请用在线付款下单!"),
            "1" === c.payType) {
            var e = b.divPrice(a);
            "0.00" != e.free ? $("#free-div").html(utils.strReplace($("#free-tpl").html(), e)).removeClass("qb_none") : $("#free-div").addClass("qb_none"), a = 100 * e.pkgTotal
        } else $("#free-div").addClass("qb_none");
        b.payPrice = a,
        b.priceNode.html("&yen;" + (a / 100).toFixed(2)),
        b.reduce + b.couponReduce < 0 ? ($("#dealoff-div").removeClass("qb_none"),
        $("#dealoff-price").html("&yen;" + ((-1 * b.reduce + -1 * b.couponReduce) / 100).toFixed(2))) : $("#dealoff-div").addClass("qb_none")
    },
    g.divPrice = function (a) {
        var b = {
            price: (a / 100).toFixed(2),
    ...
    g.handleSure = function (a) {
        // alert("确认订单在这里：33,window.pageParam.length：" + window.pageParam);
        ...
        if (!a.hasClass("btn_disabled")) {
            ...
            //alert("b.curMtype=" + b.curMtype + "b.pc=" + b.pc);//b.pc---为支付方式的值,b.curMtype---物流id

            //if ("0" === d && b.pc < 0) {
            //    return utils.showBubble("请选择支付方式33"),
            //        void 0;
            //}
            $.each(window.subParam, function (a, b) {
                e.push(b.ic + "-" + b.attr + "-" + b.bc + "-" + b.mid)
                ...
                //url: window.basePath + "/shop/shopmgr.ashx?" + window.baseParam,
                url: window.basePath + "/shop/shopmgr.ashx?myact=order_save",
                dataType: "json",
                type: "POST",
                data: {
                    //myact: "order_save",
                    ...
                    openid: $("#openid").val(),
                    wid: $("#hidwid").val(),
                    numblist: $("#numblist").val(),
                    cart: c.cart
                }
            }, function (b) {
                b.errCode ? 3 == b.errCode ? (a.removeClass("btn_disabled"), utils.showBubble("支付配置 出错!"))
                : (a.removeClass("btn_disabled"), utils.showAjaxErr(b, "下单失败，请重试"))
                : utils.payDeal(b, a)
            })
        }
    }, g.scanPromote = function (a) {
    ...
    //a.initCmdyList = function () {
    //    var a = this;
    //    a.itemList = $("#item-sec .item"),
    //    0 != a.itemLen && (a.selectAll = $("#choose-all"),
    //    a.itemList.each(function () {
    //        var b = $(this),
	//			c = b.find(".cmdy-data"),
	//			d = c.attr("supportCod"),
    ...
    a.callUnCod = function (a, b) {
        ...
        var a = this;
        0 != a.itemLen && (a.selectAll.on("click", $.proxy(this.checkboxAll, this)),
        $(".confirm_order").on("click", $.proxy(this.confirmOrder, this)),
        "false" === window.onlyonline && a.selectDivNode.on("touchstart", $.proxy(this.handlePayType, this)),
        a.itemEvent()), 0 != a.proLen && $(".problem_item").each(function () {
            var b = $(this);
            b.find(".icon_delete").on("click", function () {
                utils.showConfirm({
                    describeText: "确定要删除该商品吗？",
    ...
    a.checkboxAll = function (a) {
        ...
        c.hasClass("icon_checkbox_checked") ? ($.each(b.choseNode, function (a, b) {
            $(b).removeClass('icon_checkbox_checked').html('&#xe610;'),
            $(b).removeClass("icon_checkbox_checked")
        }), b.arrivePayNode.removeClass("btn_disabled"), b.chosedUnCodLen = 0) : ($.each(b.choseNode, function (a, c) {
            c = $(c), c.hasClass("icon_checkbox_disabled") || (c.addClass("icon_checkbox_checked"), c.addClass('icon_checkbox_checked').html('&#xe610;'), b.selectItems.number++, b.selectItems.items[$(c).attr("index")] = c)
        }), b.unSupCodLen > 0 && 0 == b.payType ? b.arrivePayNode.addClass("btn_disabled") : void 0, b.chosedUnCodLen = b.unSupCodLen), b.selectAll.toggleClass("icon_checkbox_checked"), b.selectAll.toggleClass("icon_checkbox_checked").html("&#xe610;"), b.changeSel()
    }, a.handlePayType = function (a) {
        var b = this,
			c = $(a.target),
			d = !0;
        ...
        utils.ajaxReq({
            ...
            d.errCode ? 5122 == d.errCode && 105 == d.retCode ? location.reload() : (utils.showAjaxErr(d, "修改数量失败,请稍候再试"),
            a.find(".count").val(a.attr("last-count"))) : (a.find(".count").val(b), a.attr("last-count", b),
            a.find(".single-total").html("&yen;" + (b * a.attr("price") / 100).toFixed(2)),
            c.itemCache[a.attr("id")].bc = b, c.setTotalPrice())
        }, function () {
            utils.showBubble("修改数量失败,请稍候再试"), a.find(".count").val(a.attr("last-count"))
        })
    }, a.del = function (a, b) {
        ...
        //alert("我在这里e=" + window.basePath + "/shop/shopmgr.ashx?myact=remove");
        utils.ajaxReq({
            type: "POST",
            url: window.basePath + "/shop/shopmgr.ashx?myact=remove",
            data: i,
    ...
    a.emptyCartIfNone = function (a) {
        ...
        //  alert("结算1-2:" + b.selectItems.items.length);
        //for (var e in b.selectItems.items) c.push(b.itemCache[e].mid);
    ...
    g.init = function () {
        ...
        if (!c.hasClass("btn_disabled")) {
            ...
            if (b.promList && 0 == b.promoteId && !b.showed) return utils.showBubble("您的订单可以享受满减优惠，赶快选择优惠方案吧！"), b.showed = !0, !1;
            if (1 == b.curPtype && b.payPrice < 500) return utils.showBubble("您购买的商品总价过低，无法使用货到付款功能，请用在线付款下单!"), !1;
            if (b.pc < 0 && 1 != b.curPtype) return utils.showBubble("请选择支付方式44"), !1;
    ...
    a.init = function () {
        ...
        if (this.buyNode.hasClass("btn_strong")) {
            if (window.totalStock > 0 && window.sku.length > 0 && !this.buyProperty) return utils.showBubble(this.errorMsg), void 0;
            if (window.wxInfo && "true" !== window.wxInfo.isFocus) return business.focus("购买商品，需要关注该商户，是否立即关注?", $.proxy(a.handleBuy, this)), void 0;
            $("#attr").val(encodeURIComponent(this.buyProperty)), $("#mid").val(window.availSku[this.buyProperty].pid), $("#bc").val(this.buyNum),
            a.addCart();
            document.detailForm.submit()
        }
    }, a.addCart = function () {
        ...
        // alert("window.basePath=" + window.basePath + "this.buyNum" + this.buyNum + "ic=" + $("#ic").val() + " attr=" + this.buyProperty + " mid=" + window.availSku[this.buyProperty].pid + " bc=" + this.buyNum + " openid=" + $("#openid").val() + " totprice=" + $("#totprice").val());//我添加的
        utils.ajaxReq({
            url: window.basePath + "/shop/shopmgr.ashx",
            dataType: "json",
            type: "POST",
            data: b
        }, function (b) {
            ...
            b.errCode ? utils.showConfirm({
                ...
                sureFn: function () {
                    ...
                    location.href = window.basePath + "/shop/cart.aspx?wid=" + $("#wid").val() + "&openid=" + $("#openid").val()
                }
            })
        })
    }, a.handleOpen = function () {
        ...
        if (c.selectedCount == window.sku.length) {
            var d = c.matchProperty.join("|");
            c.buyProperty = d, a = window.availSku[d], a && ($("#buyNum").val(1), b = a.stockCount, (a.stockCount == "0") ? ($("#J_buydisable").show(), $("#J_buy").hide()) : ($("#J_buydisable").hide(), $("#J_buy").show()), (a.stockCount == "") ? ($("#stock-num-prev").html("不"), $("#stock-num-next").html("限"), $("#stock-num").html("99").hide()) : ($("#stock-num-prev").html("剩余"), $("#stock-num-next").html("件"), $("#stock-num").html(b).show()), c.curStock = (a.stockCount == "") ? 9999 : parseInt(b, 10), $("#price").html("&yen;" + (a.stockPrice / 100).toFixed(2)), $("#totprice").val((a.stockPrice / 100).toFixed(2)), $("#maketPrice").html("&yen;" + (a.maketPrice / 100).toFixed(2)))
        }
    }, a.handleInput = function (a) {
        var b = $(a.target),
			c = b.val(),
    ...
    a.init = function () {
        ...
        // alert("确认订单22 " + a.getAttribute("url") + "?" + window.baseParam);
        utils.ajaxReq({
            url: a.getAttribute("url") + "&" + window.baseParam,
            data: { order_id: a.getAttribute("dc") },
            dataType: "json"
